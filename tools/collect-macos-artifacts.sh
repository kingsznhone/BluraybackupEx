...
artifact_dir="$repo_root/dist/macos"
staging_dir="$artifact_dir/bluraybackup-ex.macos_x64"
tar_path="$artifact_dir/bluraybackup-ex.macos_x64.tar.gz"
...
printf 'macOS artifact collected: %s\n' "$tar_path"
